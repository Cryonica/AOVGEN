    ...
    public partial class EditorV2
    {
        ...
        private void EditorV2_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (var posInfo in VentSystem.ComponentsV2)
                {
                    ...
                    if (posInfo.SizeY == 1)
                    {
                        ...
                        {
                            hash = MD5HashGenerator.GenerateKey(new[] { posInfo.PozX, posInfo.PozY + i });
                            if (!OccupDict.ContainsKey(hash)) OccupDict.Add(hash, posInfo);
                        }
                    }
                    else
                    {
                        hash = MD5HashGenerator.GenerateKey(posInfo.Pos);
                    }
                    ...
                    if (!OccupDict.ContainsKey(hash))
                    {
                        OccupDict.Add(hash, posInfo);
                    }
            ...
            void CreateCrossSectionButtons()
            {
                ...
                var Item1 = new ToolStripButton("Соединение1", Resources.cross1, imageButton9LayoutClicked,
                    "Соединение1");
                var Item1T = new ToolStripButton("Соединение1 с датчиком Т в канале", Resources.cross1T,
                    imageButton9LayoutClicked, "Соединение1Т"); //Соединение1ТН
                var Item1TH = new ToolStripButton("Соединение1 с датчиками Т,H в канале", Resources.cross1TH,
                    imageButton9LayoutClicked, "Соединение1ТН");
                var Item2 = new ToolStripButton("Соединение2", Resources.cross2, imageButton9LayoutClicked,
                    "Соединение2");
                var Item3 = new ToolStripButton("Соединение3", Resources.cross3, imageButton9LayoutClicked,
                    "Соединение3");
                var Item4 = new ToolStripButton("Соединение4", Resources.cross4, imageButton9LayoutClicked,
                    "Соединение4");
                var Item5 = new ToolStripButton("Соединение5", Resources.cross5, imageButton9LayoutClicked,
                    "Соединение5");
                var Item6 = new ToolStripButton("Соединение6", Resources.cross6, imageButton9LayoutClicked,
                    "Соединение6");
                var Item7 = new ToolStripButton("Соединение7", Resources.cross7, imageButton9LayoutClicked,
                    "Соединение7");
                var Item8 = new ToolStripButton("Соединение8", Resources.cross8, imageButton9LayoutClicked,
                    "Соединение8");
                var Item9 = new ToolStripButton("Соединение9", Resources.cross9, imageButton9LayoutClicked,
                    "Соединение9");
                var Item10 = new ToolStripButton("Соединение10", Resources.cross10, imageButton9LayoutClicked,
                    "Соединение10");
                var Item11 = new ToolStripButton("Соединение11", Resources.cross11, imageButton9LayoutClicked,
                    "Соединение11");
                Item1.Tag = "cross1";
                Item1T.Tag = "cross1T";
                ...
                string[] images =
                {
                    "cross1", "cross1T", "cross1TH", "cross2", "cross3", "cross4", "cross5", "cross6", "cross7",
                    "cross8", "cross9", "cross10", "cross11"
                };
        ...
        private void mouseEvent(object sender, MouseEventArgs e)
        {
                ...
                .Cast<DoubleBufferedBunifuImageButton>())
            {
                ...
                if (curobjPosInfo.PozY == 4 && curobjPosInfo.SizeY > 0 || curobjPosInfo.PozX < 0 ||
                    curobjPosInfo.PozY > 4 || curobjPosInfo.PozX > 14)
                {
                ...
                case MouseButtons.Right:
                    if (currObject == null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                CreateBigButton(lastSelectedImage, lastComponent.GetType(), lastPosInfo.SizeX,
                                    lastPosInfo.SizeY, ((dynamic)lastPosInfo.ImageName));
                            }
                        }
                    }
                    else
                            ...
                            case DoubleBufferedBunifuImageButton button1: //end select
                                {
                                    if (currObject.Equals(sender))
                                    {
                                        ...
                                        if (!present)
                                        {
                                            if (posInfo1.SizeX > 0 || posInfo1.SizeY > 0)
                                            {
                                                for (var Y1 = 0; Y1 <= posInfo1.SizeY; Y1++)
                                                {
                                                    for (var X1 = 0; X1 <= posInfo1.SizeX; X1++)
                                                    {
                                                        ...
                                                        string bighash = MD5HashGenerator.GenerateKey(hashmas);
                                                        var occupied =
                                                            OccupDict.ContainsKey(MD5HashGenerator.GenerateKey(bighash));
                                                        if (!occupied)
                                                        {
                                                            OccupDict.Add(bighash, posInfo1);
                                                        }
                                                    }
                                                }
                                            }
                                            ...
                                            currObject?.GetType().GetProperty("BackColor")
                                                ?.SetValue(currObject, Color.Transparent);
                                            switch (posInfo1.Tag?.GetType().Name)
                                            {
                                                case nameof(SupplyVent):
        ...
        private async void BunifuImageButton1_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                if (e.Button == MouseButtons.Left && currObject == null)
                {
                    ...
                    var SupplyItem = new ToolStripButton("Приточный вентилятор", Resources.fan_right,
                        imageButton1LayoutClicked, "Приток")
                    {
                        Tag = "fan_right"
                    };

                    var ExtItem = new ToolStripButton("Вытяжной вентилятор", Resources.fan_left,
                        imageButton1LayoutClicked, "Вытяжка")
                    {
                        Tag = "fan_left"
                    };

                    var SupplyItemDual = new ToolStripButton("Приточный вентилятор с резервом",
                        Resources.fan_right_dual, imageButton1LayoutClicked, "Приток сдвоенный")
                    {
                        Tag = "fan_right_dual"
                    };
                    var ExtItemDual = new ToolStripButton("Вытяжной вентилятор с резервом", Resources.fan_left_dual,
                        imageButton1LayoutClicked, "Вытяжка сдвоенный")
                    {
                        Tag = "fan_left_dual"
                    };
        ...
        private async void BunifuImageButton3_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                if (e.Button == MouseButtons.Left && currObject == null)
                {
                    ...
                    //string[] layouts = new string[] { "Test 1", "Test 2", "Test 3" };
                    var items = new List<ToolStripButton>();
                    var SupplyItem = new ToolStripButton("Приточная заслонка", Resources.shutter_right,
                        imageButton3LayoutClicked, "Приток")
                    {
                        Tag = "shutter_right"
                    };
                    var ExtItem = new ToolStripButton("Вытяжная заслонка", Resources.shutter_left,
                        imageButton3LayoutClicked, "Вытяжка")
                    {
                        Tag = "shutter_left"
                    };
                    var SupplyItemT = new ToolStripButton("Приточная заслонка с датчком наружной Т",
                        Resources.shutter_right_T, imageButton3LayoutClicked, "ПритокТ")
                    {
                        Tag = "shutter_right_T"
                    };
        ...
        private async void BunifuImageButton10_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                if (e.Button == MouseButtons.Left && currObject == null)
                {
                    ...
                    //string[] layouts = new string[] { "Test 1", "Test 2", "Test 3" };
                    var items = new List<ToolStripButton>();
                    var Item1 = new ToolStripButton("Помещение, приток", Resources.room__arrow_supply,
                        imageButton10LayoutClicked, "Соединение1");
                    var Item1T = new ToolStripButton("Помещение, приток с датчик.Т ", Resources.room__arrow_supply_T,
                        imageButton10LayoutClicked, "Соединение1Т"); //Соединение1ТН
                    var Item1TH = new ToolStripButton("Помещение, приток с датчик.Т, Н",
                        Resources.room__arrow_supply_TH, imageButton10LayoutClicked, "Соединение1ТН");
                    var Item2 = new ToolStripButton("Помещение, вытяжка влево", Resources.room__arrow_exhaust_L,
                        imageButton10LayoutClicked, "Соединение2");
                    var Item3 = new ToolStripButton("Помещение, вытяжка вправо", Resources.room__arrow_exhaust_R,
                        imageButton10LayoutClicked, "Соединение3");
                    var Item4 = new ToolStripButton("Помещение, приток, вытяжка", Resources.room__arrow_supp_exh,
                        imageButton10LayoutClicked, "Соединение4");
                    var Item5 = new ToolStripButton("Помещение, приток, вытяжка, с датч.Т",
                        Resources.room__arrow_supp_exh_T, imageButton10LayoutClicked, "Соединение5");
                    var Item6 = new ToolStripButton("Помещение, приток, вытяжка, с датч.Т, Н",
                        Resources.room__arrow_supp_exh_TH, imageButton10LayoutClicked, "Соединение6");
                    string[] images =
                    {
                        "room__arrow_supply", "room__arrow_supply_T", "room__arrow_supply_TH", "room__arrow_exhaust_L",
                        "room__arrow_exhaust_R", "room__arrow_supp_exh", "room__arrow_supp_exh_T",
                        "room__arrow_supp_exh_TH"
                    };
                    items.Add(Item1);
                    items.Add(Item1T);
                    items.Add(Item1TH);
        ...
        private void radButton12_Click(object sender, EventArgs e)
        {
            ...
            {
                new Animator3D(
                        new Path3D(BackColor.ToFloat3D(), Color.Red.ToFloat3D(), 1000, 0,
                            AnimationFunctions.CircularEaseIn),
                        FPSLimiterKnownValues.NoFPSLimit)
                    .Play(panel3, "BackColor");
                new Animator3D(
                        new Path3D(Color.Red.ToFloat3D(), BackColor.ToFloat3D(), 1000, 1001,
                            AnimationFunctions.CircularEaseOut),
                        FPSLimiterKnownValues.NoFPSLimit)
                    .Play(panel3, "BackColor");
            }
        }
        ...
        {
            return new Point((Screen.PrimaryScreen.Bounds.Size.Width / 2) - (Size.Width / 2),
        ...
        private Point GetRelativePoint(object sender)
        {
            ...
            return new Point(Center().X + button.Location.X + 120,
                Center().Y + button.Location.Y + button.Size.Height / 2);
        }
        #endregion
